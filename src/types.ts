...
export type FlashcardProposalDto = Pick<FlashcardsRow, "id" | "front" | "back" | "source">;

// DTO for generation response (used in POST and GET /api/generations)
export type GenerationResponseDto = Pick<GenerationsRow, "id" | "generated_count" | "created_at"> & {
